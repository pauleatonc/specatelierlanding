...
class SubmitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submit" do
    assert_difference('Submit.count') do
      post submits_url, params: { submit: { comment: @submit.comment, email: @submit.email, name: @submit.name, office: @submit.office } }
    end
  ...
  test "should update submit" do
    patch submit_url(@submit), params: { submit: { comment: @submit.comment, email: @submit.email, name: @submit.name, office: @submit.office } }
