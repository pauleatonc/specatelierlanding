...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { comments: @register.comments, email: @register.email, name: @register.name, office: @register.office } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { comments: @register.comments, email: @register.email, name: @register.name, office: @register.office } }
